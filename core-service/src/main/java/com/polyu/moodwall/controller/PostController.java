...
public class PostController {
    ...
    public ResponseEntity<Void> likePost(
        ...
        var success = wallService.likePost(postId, userHash);
    ...
    public ResponseEntity<Void> commentPost(
        ...
        var success = wallService.commentPost(postId, userHash, comment);
        return success ? ResponseEntity.ok().build() : ResponseEntity.notFound().build();
    }

    @GetMapping("/{postId}/comments")
    public ResponseEntity<List<PostInteraction>> getComments(@PathVariable Long postId) {
        List<PostInteraction> comments = wallService.getComments(postId);
